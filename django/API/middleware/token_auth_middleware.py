...
class TokenAuthMiddleware(MiddlewareMixin):
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        exclusion_list=['accounts.views.token_status','accounts.views.token_rest_status','accounts.api.LoginAPI','accounts.views.forgetPassword','embededPowerBI.views.updatePowerBiRefreshButtonStatusWS','talendEsb.views.updateMetaDataFileInTableTransactionsLivraisonWS','core.views.updateMetaDataFileInTableCoreEDIFileWS','core.views.updateMetaDataFileInTableCoreLogisticFileWS']
